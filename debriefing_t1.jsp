...
<tr><td>
	...
	<p align="center" class="text"><strong>You have completed the first session.</strong></p>
    ...
    <p class="text">The categorization task you completed is called the Implicit Association Test (IAT). The task assesses associations between concepts by measuring how quickly a person can categorize, for example, GOOD words with White faces compared to GOOD words with Black faces. The test often reveals associations that are different than one's conscious beliefs. For example, even people who have no conscious preference between Black and White may still have implicit associations that White is better than Black. The purpose of this study is to test how associations can be changed by thinking about multicultural values. Prior to doing the IAT, some participants read and wrote about multiculturalism whereas others read and wrote about academic freedom. </p>
    <p class="text">You also may take the IAT a second time to assess the impact of these experiences over time. Thinking about multiculturalism may have fleeting effects, or it may induce psychological change that lasts. As such, if your measure was particularly effective at shifting your implicit responses, you may be interested to return to the demonstration site in the future, and try out the race task again to see if your results are the same or different. 
